...
'''
PATIENCE = 5
MODEL_NAME = f'ff_effnetb0_1fc_global_2epoch'
...
def train_no_earlystop(epochs, optimizer, model, train_loader, val_loader):
    print('train start')
    train_loss_history = []
...
if __name__ == '__main__':
    ...
    train_loss_history, val_loss_history, train_accuracy_history, val_accuracy_history = train_no_earlystop(EPOCHS, optimizer, model, train_loader, val_loader)
